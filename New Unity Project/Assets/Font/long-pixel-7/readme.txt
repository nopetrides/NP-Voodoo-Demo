...
True Type Font: Long Pixel-7 version 1.0


EULA
-==-
The font Long Pixel-7 is freeware for home use only.


DESCRIPTION
-=========-
Original pixel font. Size of base symbol is 5*11 pixels. Latin and Cyrillic code pages are supported.

Files in long_pixel-7.zip:
       	readme.txt     			this file;
        long_pixel-7.ttf    		regular font;
	long_pixel-7_screen.png		preview image.
